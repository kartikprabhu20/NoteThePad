...
sealed class AddEditNoteEvent {
    ...
    data class AttachPaint(val uri: Uri) : AddEditNoteEvent()
    data class RemovePaint(val uri: Uri) : AddEditNoteEvent()
    ...
    data class RemoveChecklistItem(val id: String) : AddEditNoteEvent()
    ...
    data object Undo : AddEditNoteEvent()
    data object Redo : AddEditNoteEvent()
}
