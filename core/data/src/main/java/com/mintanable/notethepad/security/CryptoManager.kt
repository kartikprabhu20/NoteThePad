package com.mintanable.notethepad.security
...
class CryptoManager(private val context: Context) {
    ...
    private val aead: Aead by lazy {
        try {
            ...
            if (e.message?.contains("master_key") == true || e is GeneralSecurityException) {
                Log.e("CryptoManager", "Keystore corruption detected. Attempting reset.")
                handleKeyCorruption()
                createAead()
            } else {
                throw e
